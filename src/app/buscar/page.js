      ...
      <section className='w-full flex flex-col gap-10 mb-2 p-10'>
        {
          ...
          (
            <p className="text-gray-500">No se encontraron propiedades cercanas.</p>
          )
        }     
      </section>
    )
...
export default function page() {
  return (
    <div className='w-full min-h-screen'>
      ...
      <Suspense fallback={<p className="p-10 text-lg">Cargando resultados...</p>}>
        <SarchNearbyComponent/>
      </Suspense>
    </div>
  )
}
