...
export default function FormularioEditProperty({
    data,
    handleSaveNewData,
  ...
  return (
    <div className='flex flex-col'>
        <h1 className='font-bold text-2xl'>Información de la propiedad</h1>
        ...
        <h1 className='mt-4'>Descricion de proyecto</h1>
        <Textarea
            name="description"
