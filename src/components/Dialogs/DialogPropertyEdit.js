...
import FormularioEditProperty from '../Tables/elements/FormularioEditProperty'

export default function DialogPropertyEdit({
  data,
  isOpen=false,
  handleChangeOpen,
  handleSaveNewData,
  ...
  return (
    <aside className='relative'>
      ...
      <div
        className={
          `z-20 fixed top-0 right-0 max-h-screen overflow-y-auto w-[600px] lg:w-1/2 bg-white shadow-lg p-6 transform  transition-transform duration-300 ${
      ...
      >
        ...
        <h2 className='text-3xl font-bold mb-4'>Editar Propiedad</h2>
        <FormularioEditProperty
